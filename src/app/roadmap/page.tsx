...
const roadmapItems: RoadmapItem[] = [
	...
	},
	{
		...
		description:
			'An "Edit with NVAI" badge web apps can integrate. Shows on video players.',
		status: {
			text: "Not started",
			type: "default",
		},
...
export const metadata: Metadata = {
	title: "Roadmap - NVAI",
	description:
		"See what's coming next for NVAI - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "NVAI Roadmap - What's Coming Next",
		description:
			"See what's coming next for NVAI - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description="What's coming next for Video Audio Editor (last updated: February 17, 2026)"
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="NVAI is open source and built by the community. Every contribution,
